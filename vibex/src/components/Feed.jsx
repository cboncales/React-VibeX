  ...
  return (
    <div className="flex flex-[2] flex-col items-center justify-center gap-3 px-3">
      ...
      <Posts
        ...
        name="Emmanuel"
      />
      <Posts darkMode={darkMode} image={image8} friend={friend2} name="Roy" />
      <Posts
        darkMode={darkMode}
        image={image3}
        friend={friend3}
        name="Stanley"
      />
      <Posts darkMode={darkMode} image={image5} friend={friend7} name="Ken" />
      <Posts darkMode={darkMode} image={image4} friend={friend4} name="Greg" />
      <Posts
        darkMode={darkMode}
        image={image7}
        friend={friend3}
